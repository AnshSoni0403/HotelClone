...
const indianLocations: LocationCard[] = [
  ...
  },
  {
    ...
    attractions: ["Saheliyon Ki Bari","City Palace", "Lake Pichola", "Jag Mandir","Jal Mahal"],
    bestTime: "Oct - Mar",
  ...
  },
  {
    ...
    rating: 4.5,
    description: "Colonial charm meets mountain beauty in this popular hill station with scenic toy train rides. Place your stay at any of our premium locations and experience the best of Indian hospitality.",
    attractions: ["Mall Street Road", "Jakhu Temple", "Christ Church", "Toy Train"],
  ...
  },
  {
    ...
    attractions: ["Hawa Mahal","Jantar Mantar", "The Amber Fort", "City Palace", "Jal Mahal"],
    bestTime: "Oct - Mar",
