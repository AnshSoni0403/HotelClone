    ...
    <div className="min-h-screen pt-32">
      ...
      <section className="relative py-20 bg-gradient-to-r from-amber-900 to-amber-800 text-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          >
            We're here to help make your stay unforgettable. Get in touch with us today.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <ScrollAnimation>
              <div className="bg-gray-50 rounded-2xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-amber-600 hover:bg-amber-700 text-white px-8 py-4 rounded-lg font-semibold transition-colors duration-300 flex items-center justify-center space-x-2 transform hover:scale-105"
                  >
            ...
            <ScrollAnimation delay={0.2}>
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Our dedicated team is available 24/7 to assist you with reservations, inquiries, and any special
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        General: info@freelanceaxisgrand.com
                        <br />
                        Reservations: reservations@freelanceaxisgrand.com
                        <br />
                        Events: events@freelanceaxisgrand.com
                      </p>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg">
              <div className="h-96 bg-gray-200 flex items-center justify-center">
                <iframe
                  ...
                  title="Freelance Axis Grand Hotel Location"
                />
              </div>
            </div>
          </ScrollAnimation>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <ScrollAnimation>
            ...
            <p className="text-xl text-amber-100 mb-6">
              For urgent matters or emergencies, please contact our 24/7 hotline
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <div className="flex items-center space-x-2">
                <Phone className="w-6 h-6" />
                <span className="text-xl font-semibold">+1 (555) 911-HELP</span>
              </div>
              <div className="hidden sm:block text-amber-300">|</div>
              <div className="flex items-center space-x-2">
                <Mail className="w-6 h-6" />
                <span className="text-xl font-semibold">emergency@freelanceaxisgrand.com</span>
              </div>
            </div>
          </ScrollAnimation>
        </div>
